...
export default function Page() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <section id="start" className="relative z-10 isolate flex min-h-[720px] items-end bg-primary/65 pb-16 pt-32 lg:min-h-[780px] lg:items-center lg:pb-0">
        <div className="absolute inset-0 -z-10 bg-gradient-to-r from-primary/75 via-primary/45 to-primary/10" />
